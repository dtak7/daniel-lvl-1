...
public void burn(){
	System.out.println(" BUT you were an evil person and have burned your textbook, as the ashes fly into the air your maniacal cackle fills the air.");
}
}